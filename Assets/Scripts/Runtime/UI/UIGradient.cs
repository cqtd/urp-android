...
namespace UnityEngine.Cinemachine.Modules
{
    public class UIGradient : BaseMeshEffect
    {
        [Header("GRADIENT")] [SerializeField] UnityEngine.Gradient _effectGradient = new UnityEngine.Gradient()
        {
            colorKeys = new GradientColorKey[]
                {new GradientColorKey(Color.black, 0), new GradientColorKey(Color.white, 1)}
        };

        [Header("SETTINGS")] [SerializeField] Type _gradientType;
